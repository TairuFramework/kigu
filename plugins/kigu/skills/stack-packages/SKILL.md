...
Provides OpenTelemetry tracing, context propagation, and log bridging for stack RPC.
...
| `@enkaku/react` | React hooks for the RPC client |
| `@enkaku/electron` | RPC over Electron IPC (main/preload/renderer) |
...
| `@kumiai/hub-tunnel` | Tunnel transport over the hub relay |
